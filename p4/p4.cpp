...
const int FACE = 14; // number of card numbers for for loop 1 -13
const int QUANTITY = 4; // number of each card to multiply 4 times
const int INITIAL = 7; // initial number of cards to give to each player
