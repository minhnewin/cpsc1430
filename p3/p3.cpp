...
int main() {
   TicTacToe game; // TicTacToe object used to access functions in the
                   // TicTacToe class
   int row; // integer variable for inputing row in the board array
   int col; // integer variable for inputing col in the board array
   char ans; // variable to check to see if the user wants to keep playing
   char player; // character value for player, switches between X and O
   bool playerXTurn = true; // bool to switch between player X and O
   bool gameWon = false; // bool to check if game has been won
   int turn; // integer value to check if the game has tied
   bool invalid = false; // bool value to check if user input was valid
